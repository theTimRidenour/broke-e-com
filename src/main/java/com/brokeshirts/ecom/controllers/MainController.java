...
import com.brokeshirts.ecom.models.AddressesData;
import com.brokeshirts.ecom.models.CategoriesData;
import com.brokeshirts.ecom.models.ColorsData;
import com.brokeshirts.ecom.models.CustomersData;
import com.brokeshirts.ecom.models.InventoryData;
import com.brokeshirts.ecom.models.ProductsData;
import com.brokeshirts.ecom.models.SizesData;
...
public class MainController {
    ...
    public String index(Model model) {
        ...
        for (Products productType : ProductsData.getByType(1)) {
            shirts.add(productType);
        }
        for (Products productType : ProductsData.getByType(2)) {
            shirts.add(productType);
        }
        for (Products productType : ProductsData.getByType(3)) {
            shirts.add(productType);
        }
        for (Products productType : ProductsData.getByType(4)) {
            shirts.add(productType);
        }
        for (Products productType : ProductsData.getByType(5)) {
            shirts.add(productType);
        }
